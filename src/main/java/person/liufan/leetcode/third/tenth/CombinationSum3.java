package person.liufan.leetcode.third.tenth;
 ...
 * @package: person.liufan.leetcode.third.ninth
    ...
    public List<List<Integer>> combinationSum(int[] candidates, int target,int index) {
        ...
        for (int i = index; i < candidates.length; i++) {
            ...
            if (target == candidate) {
                ...
                List<List<Integer>> list = combinationSum(candidates, target - candidate, i + 1);
                results.addAll(list);
