package person.liufan.leetcode.zero.zero.three.eighth;

/**
 * @author: liufan
 * @E-mail: fan.liu@biz-united.com.cn
 * @package: person.liufan.leetcode.thousand.hundred.third.eighth
 * @description:
...
public class CountAndSay {
    ...
    public String countAndSay(int n) {
        ...
        if (chars.length == 1 || chars[chars.length - 1] != chars[chars.length - 2]) {
            builder.append(1).append(chars[chars.length - 1]);
        } else {
